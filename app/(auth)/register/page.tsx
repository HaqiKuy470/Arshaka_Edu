...
export default function RegisterPage() {
  return (
    <div className="flex-1 flex flex-col items-center justify-center relative py-12 px-4">
      {/* Background blobs */}
      <div className="absolute top-[20%] right-[20%] w-[30%] h-[30%] rounded-full bg-indigo-600/20 blur-[120px] pointer-events-none" />
      <div className="absolute bottom-[20%] left-[20%] w-[30%] h-[30%] rounded-full bg-pink-600/20 blur-[120px] pointer-events-none" />
      ...
      <div className="w-full max-w-md z-10">
        ...
        <div className="glass-card rounded-3xl p-8 border border-white/10 shadow-2xl">
          <div className="text-center mb-8">
            ...
            <p className="text-zinc-400">Bergabung dengan Arshaka Edu dan mulai petualangan sains Anda</p>
          </div>
          ...
          <div className="mt-8 text-center text-sm text-zinc-400">
            Sudah punya akun? <Link href="/login" className="text-indigo-400 hover:text-indigo-300 font-medium">Masuk di sini</Link>
          </div>
        </div>
      </div>
    </div>
